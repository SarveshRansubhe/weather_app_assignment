...
import 'package:weather_app_assignment_assignment/src/login.dart';
import 'package:weather_app_assignment_assignment/src/shared/constants/lottie_url.dart';
import 'package:weather_app_assignment_assignment/src/shared/helper/text_helper.dart';
import 'package:weather_app_assignment_assignment/src/weather/bloc/current_weather_cubit.dart';
import 'package:weather_app_assignment_assignment/src/weather/bloc/location_cubit.dart';
            ...
            return Scaffold(
              body: SafeArea(
                child: Scaffold(
                  ...
                  builder: (context, loc) {
                    if (loc is LocationLoaded) {
                      return BlocBuilder<CurrentWeatherCubit,
                          CurrentWeatherState>(
                                                                  ...
                                                                  (j) =>
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            Text(TextHelpers().dayTime(current.forecaste?.forecast?.forecastday?[index].hour?[j].time ??
                                                                                '')),
                                                                            Image.network('http:${current.forecaste?.forecast?.forecastday?[index].hour?[j].condition?.icon ?? ''}'),
                                                                            Text(current.forecaste?.forecast?.forecastday?[index].hour?[j].condition?.text ??
                                                                                '')
                                                                          ],
                                                                        ),
                                                                      )),
